Feature: Car detections
  ...
  Scenario: Get detections
    ...
    And the response elements contains the property "_id"
    And the response elements contains the property "Year"
    And the response elements contains the property "Make"
    And the response elements contains the property "Model"
    And the response elements contains the property "Category"
